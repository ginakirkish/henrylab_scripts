...
echo "----------  extract brain with optiBET --------------------------------------------" >> report.sienax
...
bash /data/henry6/scripts/optiBET.sh -i $I ${I}_brain >> report.sienax
${FSLDIR}/bin/fslmaths I_optiBET_brain.nii.gz I_brain.nii.gz
${FSLDIR}/bin/fslmaths I_optiBET_brain_mask.nii.gz I_brain_mask.nii.gz
...
${FSLDIR}/bin/pairreg ${FSLDIR}/data/standard/MNI152_T1_2mm_brain ${I}_brain ${FSLDIR}/data/standard/MNI152_T1_2mm_skull ${I}_brain_skull ${I}2std.mat -searchrx -180 180 -searchry -180 180 -searchrz -180 180 >> report.sienax 2>&1

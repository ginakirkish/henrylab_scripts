...
df = pd.read_csv("/home/sf522915/all_mse.csv")
writer = open("/home/sf522915/MSE5.csv", "w")
spreadsheet = csv.DictWriter(writer, 
                             fieldnames=["mseID", "Scan Date", "flair file","t2 file", "t1 file", "scanner", "sienax",
                                        "vscale", 
                                        "brain vol (u, mm3)",
                                        "WM vol (u, mm3)", 
                                        "GM vol (u, mm3)",

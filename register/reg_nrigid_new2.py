...
def run_nrigid( mse1, mse2, wd):
    ...
    cmd = ['{0}/msNrigid'.format(nrigid_path),"-mr", tp1_affine_tp2space_hdr, tp1_affine_tp2space_hdr,tp2_brain_hdr, tp1_tp2space_nrigid]
    start = time()
    print('{0}/msNrigid'.format(nrigid_path),"-mr", tp1_affine_tp2space_hdr, tp1_affine_tp2space_hdr,tp2_brain_hdr, tp1_tp2space_nrigid)
    print("**********************************")
    ...
    print('{0}/msNrigid'.format(nrigid_path), tp1_tp2space_nrigid +"_def.hdr", tp1_affine_tp2space_hdr,wd + "nrigid_back2tp1.hdr")

    print(nrigid_path + "msDeform", "-m",wd + "nrigid_back2tp1.hdr", combined_bm_tp2, wd + "combined_bm_tp2.hdr" )

    print("mri_convert",combined_bm_tp2, wd + "combined_bm_tp2.img", combined_bm_tp2, wd + "combined_bm_tp2.nii.gz" )
...
"""
    ...
    print("flirt", "-in", combined_bm_tp1tp2space.replace(".hdr", "_new.nii.gz"), "-ref",get_t1(mse1), "-init", wd +"inverse_affine.mat", "-applyxfm", "-out", wd +"final.nii.gz")
    ...
    print("**********************************")
    print("fslhd", tp1_affine_tp2space.replace(".nii.gz", "_new.nii.gz"),  ">", wd + "tp1_affine_tp2space_init.txt" )

    cmd = ["fslhd",combined_bm_tp1tp2space.replace(".hdr", "_new.nii.gz"),  ">", wd + "tp1_affine_tp2space_combined_afterfslgeomxxx.txt" ]
    print("**********************************")
    print("fslhd",combined_bm_tp1tp2space.replace(".hdr", "_new.nii.gz"),  ">", wd + "tp1_affine_tp2space_combined_afterfslgeomxxx.txt")

    cmd = ["fslcpgeom",  tp1_affine_tp2space.replace(".nii.gz", "_new.nii.gz"), combined_bm_tp1tp2space.replace(".hdr", "_new.nii.gz")]
    print("fslcpgeom",  tp1_affine_tp2space.replace(".nii.gz", "_new.nii.gz"), combined_bm_tp1tp2space.replace(".hdr", "_new.nii.gz"))
    print("**********************************")

    cmd = ["fslhd", tp1_affine_tp2space.replace(".nii.gz", "_new.nii.gz"),  ">", wd + "tp1_affine_tp2space_afterfslgeom.txt" ]
    print("fslhd", tp1_affine_tp2space.replace(".nii.gz", "_new.nii.gz"),  ">", wd + "tp1_affine_tp2space_afterfslgeom.txt" )
    print("**********************************")

    cmd = ["fslhd",combined_bm_tp1tp2space.replace(".hdr", "_new.nii.gz"),  ">", wd + "tp1_affine_tp2space_combined_afterfslgeom.txt" ]
    print("fslhd",combined_bm_tp1tp2space.replace(".hdr", "_new.nii.gz"),  ">", wd + "tp1_affine_tp2space_combined_afterfslgeom.txt")
    print("**********************************")

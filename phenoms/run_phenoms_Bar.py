...
def run_first(t1, reorient):
    ...
    for s in ['L_Accu', 'L_Amyg', 'L_Caud', 'L_Hipp', 'L_Puta', 'L_Thal', 'R_Accu', 'L_Pall',
        ...
        if intref == '0':
            if bcorr == '1':
                cmd = ['{}/bin/run_first'.format(FSLDIR), '-i', reorient, '-t', mat_name,
